...
7. **Study a whole game** (3) — next: Shusaku's ear-reddening game (Gennan Inseki – Shusaku, 1846), Go Seigen – Honinbo Shusai (1933, the "game of the century"), Lee Sedol – AlphaGo game 4 (2016, move 78). Records are public facts; each SGF must be checked against a published record and its origin written into the file.
