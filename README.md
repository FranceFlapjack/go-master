...
Eight tracks planned (First steps, Capturing techniques, Life and death, The opening, Joseki, Direction of play, The endgame, Study a whole game); *First steps*, *Capturing techniques*, *Life and death*, *The opening*, *Joseki*, *Direction of play* and *The endgame* are ready (41 lessons, 146 problems). Plus a play page: two players on one screen, or a weak computer opponent on 9×9 (our own Monte-Carlo search, for practice), handicap games, area counting.
